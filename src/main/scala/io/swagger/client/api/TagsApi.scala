...
class TagsApi(val defBasePath: String = "https://app.quantimo.do/api",
   ...
   */
  def v1UserTagsDeletePost (taggedVariableId: Integer, tagVariableId: Integer) : Option[CommonResponse] = {
    // create path and map variables
    val path = "/v1/userTags/delete".replaceAll("\\{format\\}","json")
    ...
    if(String.valueOf(taggedVariableId) != "null") queryParams += "taggedVariableId" -> taggedVariableId.toString
if(String.valueOf(tagVariableId) != "null") queryParams += "tagVariableId" -> tagVariableId.toString
   ...
   * @return CommonResponse
   */
  def v1UserTagsPost (body: UserTag, accessToken: String) : Option[CommonResponse] = {
    // create path and map variables
    val path = "/v1/userTags".replaceAll("\\{format\\}","json")
    val contentTypes = List("application/json", "application/json")
    val contentType = contentTypes(0)
