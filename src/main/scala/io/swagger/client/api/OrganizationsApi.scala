...
class OrganizationsApi(val defBasePath: String = "https://app.quantimo.do/api",
   ...
   */
  def v1OrganizationsOrganizationIdUsersPost (organizationId: Integer, body: UserTokenRequest, accessToken: String) : Option[UserTokenSuccessfulResponse] = {
