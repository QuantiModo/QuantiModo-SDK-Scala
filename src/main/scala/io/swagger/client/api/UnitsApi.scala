...
class UnitsApi(val defBasePath: String = "https://app.quantimo.do/api",
   ...
   * @return List[Unit]
   */
  def v1UnitsGet (accessToken: String, id: Integer, unitName: String, abbreviatedUnitName: String, categoryName: String) : Option[List[Unit]] = {
    // create path and map variables
...
if(String.valueOf(categoryName) != "null") queryParams += "categoryName" -> categoryName.toString
   ...
   * @return List[Unit]
   */
  def v1UnitsVariableGet (accessToken: String, unitName: String, abbreviatedUnitName: String, categoryName: String, variable: String) : Option[List[Unit]] = {
    // create path and map variables
