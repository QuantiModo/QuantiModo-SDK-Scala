...
class PairsApi(val defBasePath: String = "https://app.quantimo.do/api",
   ...
   * @return List[Pairs]
   */
  def v1PairsCsvGet (cause: String, effect: String, accessToken: String, causeSource: String, causeUnit: String, delay: String, duration: String, effectSource: String, effectUnit: String, endTime: String, startTime: String, limit: Integer, offset: Integer, sort: Integer) : Option[List[Pairs]] = {
    // create path and map variables
    val path = "/v1/pairsCsv".replaceAll("\\{format\\}","json")
...
if(String.valueOf(sort) != "null") queryParams += "sort" -> sort.toString
   ...
   * @return List[Pairs]
   */
  def v1PairsGet (cause: String, effect: String, accessToken: String, causeSource: String, causeUnit: String, delay: String, duration: String, effectSource: String, effectUnit: String, endTime: String, startTime: String, limit: Integer, offset: Integer, sort: Integer) : Option[List[Pairs]] = {
    // create path and map variables
