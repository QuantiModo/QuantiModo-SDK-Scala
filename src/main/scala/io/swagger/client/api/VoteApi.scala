...
class VoteApi(val defBasePath: String = "https://app.quantimo.do/api/v2",
   ...
   */
  def votesGet (clientId: String, userId: Integer, causeId: Integer, effectId: Integer, value: Integer, createdAt: String, updatedAt: String, limit: Integer, offset: Integer, sort: String) : Option[Inline_response_200_29] = {
   ...
   */
  def votesPost (body: Vote) : Option[Inline_response_200_30] = {
    // create path and map variables
    val path = "/votes".replaceAll("\\{format\\}","json")
   ...
   * @return Inline_response_200_30
   */
  def votesIdGet (id: Integer) : Option[Inline_response_200_30] = {
    // create path and map variables
   ...
   */
  def votesIdPut (id: Integer, body: Vote) : Option[Inline_response_200_2] = {
    // create path and map variables
    val path = "/votes/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return Inline_response_200_2
   */
  def votesIdDelete (id: Integer) : Option[Inline_response_200_2] = {
    // create path and map variables
    val path = "/votes/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
