...
class UpdateApi(val defBasePath: String = "https://app.quantimo.do/api/v2",
   ...
   */
  def updatesGet (accessToken: String, userId: Integer, connectorId: Integer, numberOfMeasurements: Integer, success: Boolean, message: String, createdAt: String, updatedAt: String, limit: Integer, offset: Integer, sort: String) : Option[Inline_response_200_7] = {
   ...
   */
  def updatesPost (accessToken: String, body: Update) : Option[Inline_response_200_28] = {
    // create path and map variables
    val path = "/updates".replaceAll("\\{format\\}","json")
   ...
   * @return Inline_response_200_28
   */
  def updatesIdGet (id: Integer, accessToken: String) : Option[Inline_response_200_28] = {
    // create path and map variables
   ...
   */
  def updatesIdPut (id: Integer, accessToken: String, body: Update) : Option[Inline_response_200_2] = {
    // create path and map variables
    val path = "/updates/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return Inline_response_200_2
   */
  def updatesIdDelete (id: Integer, accessToken: String) : Option[Inline_response_200_2] = {
    // create path and map variables
    val path = "/updates/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
