...
class AuthenticationApi(val defBasePath: String = "https://app.quantimo.do/api",
   ...
   * @return void
   */
  def v2AuthSocialAuthorizeCodeGet (code: String, provider: String)  = {
    // create path and map variables
    val path = "/v2/auth/social/authorizeCode".replaceAll("\\{format\\}","json")
    ...
    if(String.valueOf(code) != "null") queryParams += "code" -> code.toString
if(String.valueOf(provider) != "null") queryParams += "provider" -> provider.toString
   ...
   * @return void
   */
  def v2AuthSocialAuthorizeTokenGet (accessToken: String, provider: String, refreshToken: String)  = {
    // create path and map variables
    val path = "/v2/auth/social/authorizeToken".replaceAll("\\{format\\}","json")
    val contentTypes = List("application/json", "application/json")
    val contentType = contentTypes(0)
    ...
    if(String.valueOf(refreshToken) != "null") queryParams += "refreshToken" -> refreshToken.toString
if(String.valueOf(accessToken) != "null") queryParams += "accessToken" -> accessToken.toString
if(String.valueOf(provider) != "null") queryParams += "provider" -> provider.toString
   ...
   * @return void
   */
  def v2AuthSocialLoginGet (redirectUrl: String, provider: String)  = {
    // create path and map variables
    val path = "/v2/auth/social/login".replaceAll("\\{format\\}","json")
    val contentTypes = List("application/json", "application/json")
    val contentType = contentTypes(0)
    ...
    if(String.valueOf(redirectUrl) != "null") queryParams += "redirectUrl" -> redirectUrl.toString
if(String.valueOf(provider) != "null") queryParams += "provider" -> provider.toString
   ...
   * @return void
   */
  def v2Oauth2AccessTokenGet (clientId: String, clientSecret: String, grantType: String, code: String, responseType: String, scope: String, redirectUri: String, state: String)  = {
    // create path and map variables
    val path = "/v2/oauth2/access_token".replaceAll("\\{format\\}","json")
    val contentTypes = List("application/json", "application/json")
    val contentType = contentTypes(0)
    ...
    if(String.valueOf(clientId) != "null") queryParams += "clientId" -> clientId.toString
...
if(String.valueOf(state) != "null") queryParams += "state" -> state.toString
   ...
   * @return void
   */
  def v2OauthAuthorizeGet (clientId: String, clientSecret: String, responseType: String, scope: String, redirectUri: String, state: String)  = {
    // create path and map variables
    val path = "/v2/oauth/authorize".replaceAll("\\{format\\}","json")
    val contentTypes = List("application/json", "application/json")
    val contentType = contentTypes(0)
